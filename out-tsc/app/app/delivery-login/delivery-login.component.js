...
DeliveryLoginComponent.ɵfac = function DeliveryLoginComponent_Factory(t) { return new (t || DeliveryLoginComponent)(i0.ɵɵdirectiveInject(i1.BsModalRef)); };
DeliveryLoginComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DeliveryLoginComponent, selectors: [["app-delivery-login"]], decls: 24, vars: 0, consts: [[1, "modal-header"], [1, "modal-title", "pull-left"], ["type", "button", "aria-label", "Close", 1, "close", "pull-right", 3, "click"], ["aria-hidden", "true"], [1, "modal-body"], [1, "login-field"], ["novalidate", ""], [1, "form-group"], ["formControlName", "mobile", "type", "text", "placeholder", "Mobile Number", 1, "form-control"], ["for", "pwd"], ["type", "password", "placeholder", "Enter password", "id", "pwd", 1, "form-control"], [1, "form-forget"], [1, "bottom-btn"], ["type", "submit", 1, "btn", "custom-btn"]], template: function DeliveryLoginComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelementStart(0, "div", 0)(1, "h4", 1);
        i0.ɵɵtext(2, "Delivery Login");
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(3, "button", 2);
        i0.ɵɵlistener("click", function DeliveryLoginComponent_Template_button_click_3_listener() { return ctx.close(); });
