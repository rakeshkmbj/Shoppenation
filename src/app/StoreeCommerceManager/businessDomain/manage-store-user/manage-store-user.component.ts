...
@Component({
  selector: 'app-manage-store-user',
  templateUrl: './manage-store-user.component.html',
  styleUrls: ['./manage-store-user.component.scss']
})
export class ManageStoreUserComponent implements OnInit {
